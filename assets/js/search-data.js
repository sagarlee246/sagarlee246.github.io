...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Projects",
          description: "A collection of projects in physics and data science.",
          section: "Navigation",
          handler: () => {
          ...
          title: "Repositories",
          description: "Selected GitHub projects and my GitHub profile.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-beyond-the-pit-wall-machine-learning-in-formula-1",
